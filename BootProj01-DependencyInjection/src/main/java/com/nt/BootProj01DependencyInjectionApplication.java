...
public class BootProj01DependencyInjectionApplication {
	...
	public Calendar createCalender() {
		System.out.println("BootProj01DependencyInjectionApplication.createCalender()");
		return Calendar.getInstance(); // return GregorianCalendar class (sub of Calendar) obj
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("=============================");
		//invoke b.method
		String result=generator.generateWishMessageString("raja");
